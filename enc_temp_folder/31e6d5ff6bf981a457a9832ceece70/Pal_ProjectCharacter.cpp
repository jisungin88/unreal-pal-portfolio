...
void APal_ProjectCharacter::SetActionState(EActionState NewState)
{
	...
	const EActionState Old = ActionState;
	ActionState = NewState;

	UE_LOG(LogTemp, Verbose, TEXT("[ActionState] %s -> %s"), *UEnum::GetValueAsString(Old), *UEnum::GetValueAsString(NewState));

	OnActionStateChanged.Broadcast(Old, NewState);
}

bool APal_ProjectCharacter::CanStartAction(EActionState DesiredState) const
{
	switch (ActionState)
	{
	...
	case EActionState::Attack:
		return DesiredState == EActionState::Dodge;
